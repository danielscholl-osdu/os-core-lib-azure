...
/**
 * {@link ILogger} implementation with Slf4J Logger with sampling enabled. Sampling can be applied to different log types by configuring the sampling percentage in service application.properties file.
 */
@Component
@Primary
@ConditionalOnProperty(value = "logging.slf4jlogger.sampling.enabled", havingValue = "true")
public final class Slf4JLoggerSampler implements ILogger {
    private static final String DEFAULT_LOGGER_NAME = Slf4JLoggerSampler.class.getName();
